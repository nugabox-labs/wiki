...
1. Container Manager → 레지스트리에서 `mariadb` 이미지
1. 폴더: `docker/mariadb/config`, `docker/mariadb/data`
1. 볼륨 매핑: config → `/etc/mysql/conf.d`, data → `/var/lib/mysql`
...
관련: [시놀로지 MariaDB 설정](https://app.notion.com/p/4f64d96316ca4a3797424e2cf62afe55)
