...
# 예시
sshpass -pP@ssw0rd ssh -o StrictHostKeyChecking=no -p22 root@135.79.246.99
```
...
# 예시
sshpass -pP@ssw0rd ssh-copy-id root@123.45.67.102
```
...
# 예시
sshpass -pP@ssw0rd ssh -o StrictHostKeyChecking=no root@135.79.246.99 hostname
```
...
# 예시
sshpass -pP@ssw0rd scp -o StrictHostKeyChecking=no hello.txt root@135.79.246.99:/root/hello.txt
```
