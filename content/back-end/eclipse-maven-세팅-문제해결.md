...
external_url = "https://app.notion.com/p/cf071ecc145b4a8db6be8f5fa12c7146"
+++
...
- 상세: Tomcat J2EE/Java EE Web modules 버전 불일치

## `Handler processing failed` → `StackOverflowError`
...
- Project Properties → Java Build Path → Libraries에서 Tomcat·JDK 경로 확인
- Run → Maven Build
