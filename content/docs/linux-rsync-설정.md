...
- 예시
  ```bash
rsync -avPz -l -t -e ssh user@host:/home/user/www/ /home/user/public_html

# 백업할 원본의 주소는 반드시 마지막에 슬래시(/) 붙이기
# SSH 기본 포트(22)가 아닐 때 : "ssh -p 포트번호" 반드시 큰따옴표 붙이기

rsync -avPz --stats -l -t -e "ssh -p 1526" user@backuphost:/home/user/ /backup
  ```
...
set timeout -1
log_user 0
spawn rsync -avPz -l -t -e ssh user@host:/home/user/www/ /home/user/public_html
expect "password: "
send "1q2w3e4r\n"
log_user 1
interact
